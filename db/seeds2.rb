...
neil = User.create!([
  {email: "neil@neil.com", password: "password", first_name: "Neil", last_name: nil, provider: nil, uid: nil, user_avatar: nil, remote_user_avatar_url: "http://imageshack.com/a/img910/5674/LvpYQ2.jpg"} ])

u1 = User.create!([
  {email: "u1@u1.com", password: "password", first_name: "Bill", last_name: "u1l", provider: nil, uid: nil, user_avatar: nil, remote_user_avatar_url: "http://imageshack.com/a/img910/8899/UeH7bI.png"} ])

test = User.create!([
  {email: "test@hotmail.com", password: "password", first_name: nil, last_name: nil, provider: nil, uid: nil, user_avatar: nil} ])

u2 = User.create!([
  {email: "u2@u2.com", password: "password", first_name: "Sam", last_name: "u2l", provider: nil, uid: nil, user_avatar: nil, remote_user_avatar_url: "http://imageshack.com/a/img540/2414/ogEPy2.jpg"} ])

u3 = User.create!([
  {email: "u3@u3.com", password: "password", first_name: "Tony", last_name: "u3l", provider: nil, uid: nil, user_avatar: nil, remote_user_avatar_url: "http://imageshack.com/a/img538/7936/0IEVSX.jpg"} ])
...
Bill.create!([
  ...
  {name: "test 1", amount: 50.0, deadline: nil, bill_type_id: 17, group_id: 6},
...
Share.create!([
  {bill_type_id: 17, grouping_id: 16, percent: 50},
